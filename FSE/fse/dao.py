...
Returns:
    a dictionary object containing the player and the id generated by adding it to the database
"""
...
"""Get a players from the database by name

Returns:
    a dictionary object containing players with a name matching the characters in the search term
"""
...
"""Get a player from the database using their id

Returns:
    a dictionary object containing all information on the player
"""
...
"""Convert from a dictionary object to a database object

Returns:
    a database object as outlined in the Player model class
"""
...
"""Convert from a database object to a dictionary object

Returns:
    a dictionary object representation of the player that can be parsed into JSON for use on the front end
"""
